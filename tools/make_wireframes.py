...
An earlier design-system draft was sensible but rendered every Santali line
as empty boxes, because its renderer had no Ol Chiki font. For an app whose entire
purpose is displaying Ol Chiki, a mockup that cannot show Ol Chiki is not a
mockup of this app.

So the palette and type scale below come from that draft's "Rural Education
